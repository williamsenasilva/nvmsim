...
SubsecondTime
DramPerfModelNormal::getAccessLatency(SubsecondTime pkt_time, UInt64 pkt_size, core_id_t requester, IntPtr address, DramCntlrInterface::access_t access_type, ShmemPerf *perf, Byte* data_buf)
{
   return DramPerfModelNormal::getAccessLatency(pkt_time, pkt_size, requester, address, access_type, perf);
}
