...
DramPerfModelNVM::DramPerfModelNVM(core_id_t core_id,
   ...
   m_total_access_latency(SubsecondTime::Zero())
{
   ...
   SubsecondTime dram_latency_stddev = SubsecondTime::FS() * static_cast<uint64_t>(TimeConverter<float>::NStoFS(Sim()->getCfg()->getFloat("perf_model/dram/nvm/standard_deviation")));
