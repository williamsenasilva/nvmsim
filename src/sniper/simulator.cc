...
void Simulator::printInstModeSummary()
{
   ...
   {
      case Config::PINTOOL:
         printf("[NVMSIM][INFO ][SIMUL] Its is a PINTOOL simulation mode\n");
         break;
      case Config::STANDALONE:
         printf("[NVMSIM][INFO ][SIMUL] Its is a STANDALONE simulation mode\n");
         break;
      default:
         printf("[NVMSIM][INFO ][SIMUL] Its is an unknown simulation mode\n");
   }
